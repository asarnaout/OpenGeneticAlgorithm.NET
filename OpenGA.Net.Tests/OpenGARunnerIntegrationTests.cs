...
public class OpenGARunnerIntegrationTests
{
    ...
    public void RunToCompletion_WithRandomReproductionSelector_ProducesValidResult(int populationSize)
    {
        ...
        var runner = OpenGARunner<int>.Initialize(population)
            ...
            .MutationRate(0.3f)
            .Crossover(s => { s.RegisterSingleOperator(c => c.ApplyOnePointCrossoverStrategy()); s.Rate(0.8f); });
    ...
    public void RunToCompletion_WithFitnessWeightedSelector_TendsTowardHigherFitness()
    {
        ...
        var runner = OpenGARunner<int>.Initialize(population)
            ...
            .MutationRate(0.2f)
            .Crossover(s => { s.RegisterSingleOperator(c => c.ApplyOnePointCrossoverStrategy()); s.Rate(0.9f); });
    ...
    public void RunToCompletion_WithTournamentReproductionSelector_WorksCorrectly()
    {
        ...
        var runner = OpenGARunner<int>.Initialize(population)
            ...
            .MutationRate(0.25f)
            .Crossover(s => { s.RegisterSingleOperator(c => c.ApplyOnePointCrossoverStrategy()); s.Rate(0.7f); });
    ...
    public void RunToCompletion_WithTargetStandardDeviationTermination_ConvergesCorrectly()
    {
        ...
        var runner = OpenGARunner<int>.Initialize(population)
            ...
            .Crossover(s => { s.RegisterSingleOperator(c => c.ApplyOnePointCrossoverStrategy()); s.Rate(0.6f); });
